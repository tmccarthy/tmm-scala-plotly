...
final case class Layout(
  ...
  xaxes: Map[AxisReference.XAxisReference, LayoutAxis] = Map.empty,
  yaxes: Map[AxisReference.YAxisReference, LayoutAxis] = Map.empty,
...
object Layout {
  ...
  implicit val encoder: Encoder[Layout] =
    ...
    }.mergeFieldsFrom[Map[AxisReference.XAxisReference, LayoutAxis]](_.xaxes)
      .mergeFieldsFrom[Map[AxisReference.YAxisReference, LayoutAxis]](_.yaxes)
