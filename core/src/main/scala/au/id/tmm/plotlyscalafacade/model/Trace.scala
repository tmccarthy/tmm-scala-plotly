...
final case class Trace(
  `type`: Option[Trace.Type],
  x: Option[DataArray],
  y: Option[DataArray],
  // TODO this can be 3 dimensional
  z: Option[DataArray],
  error_x: Option[ErrorBar],
  error_y: Option[ErrorBar],
  xaxis: Option[String],
  yaxis: Option[String],
  text: Option[OneOrArrayOf[String]],
  lat: Option[Seq[Number]],
  lon: Option[Seq[Number]],
  line: Option[ScatterLine],
  marker: Option[PlotMarker],
  mode: Option[Trace.ScatterMode],
  histfunc: Option[Trace.HistogramFunction],
  hoveron: Option[Trace.HoverOn],
  hoverinfo: Option[Trace.HoverInfo],
  hoverlabel: Option[HoverLabel],
  hovertemplate: Option[OneOrArrayOf[String]],
  hovertext: Option[OneOrArrayOf[String]],
  textinfo: Option[Trace.TextInfo],
  textposition: Option[Trace.TextPosition],
  textfont: Option[Font],
  fill: Option[Trace.Fill],
  ...
  visible: Option[BooleanOr[Trace.Visibility]],
  delta: Option[Delta],
  gauge: Option[Gauge],
  number: Option[PlotNumber],
  transforms: Option[Seq[Transform]],
  orientation: Option[Trace.Orientation],
  width: Option[OneOrArrayOf[Number]],
  boxmean: Option[Trace.BoxMean],
  opacity: Option[Number],
  showscale: Option[Boolean],
  colorscale: Option[ColorScale],
  zsmooth: Option[FalseOr[Trace.ZSmooth]],
  ygap: Option[Number],
  xgap: Option[Number],
  transpose: Option[Boolean],
  autobinx: Option[Boolean],
  xbins: Option[Trace.XBins],
  value: Option[Number],
  values: Option[Seq[Datum]],
  labels: Option[Seq[Datum]],
  direction: Option[Trace.Direction],
  hole: Option[Number],
  rotation: Option[Number],
  theta: Option[Seq[Datum]],
  r: Option[Seq[Datum]],
  customdata: Option[Seq[Datum]],
  domain: Option[Trace.Domain],
  title: Option[DataTitle],
  branchvalues: Option[Trace.BranchValues],
)
