...
final case class Trace(
  `type`: Arg[Trace.Type] = Arg.Undefined,
  x: Arg[DataArray] = Arg.Undefined,
  y: Arg[DataArray] = Arg.Undefined,
  // TODO this can be 3 dimensional
  z: Arg[DataArray] = Arg.Undefined,
  error_x: Arg[ErrorBar] = Arg.Undefined,
  error_y: Arg[ErrorBar] = Arg.Undefined,
  xaxis: Arg[String] = Arg.Undefined,
  yaxis: Arg[String] = Arg.Undefined,
  text: Arg[OneOrArrayOf[String]] = Arg.Undefined,
  lat: Arg[Seq[Number]] = Arg.Undefined,
  lon: Arg[Seq[Number]] = Arg.Undefined,
  line: Arg[ScatterLine] = Arg.Undefined,
  marker: Arg[PlotMarker] = Arg.Undefined,
  mode: Arg[Trace.ScatterMode] = Arg.Undefined,
  histfunc: Arg[Trace.HistogramFunction] = Arg.Undefined,
  hoveron: Arg[Trace.HoverOn] = Arg.Undefined,
  hoverinfo: Arg[Trace.HoverInfo] = Arg.Undefined,
  hoverlabel: Arg[HoverLabel] = Arg.Undefined,
  hovertemplate: Arg[OneOrArrayOf[String]] = Arg.Undefined,
  hovertext: Arg[OneOrArrayOf[String]] = Arg.Undefined,
  textinfo: Arg[Trace.TextInfo] = Arg.Undefined,
  textposition: Arg[Trace.TextPosition] = Arg.Undefined,
  textfont: Arg[Font] = Arg.Undefined,
  fill: Arg[Trace.Fill] = Arg.Undefined,
  fillcolor: Arg[String] = Arg.Undefined,
  showlegend: Arg[Boolean] = Arg.Undefined,
  legendgroup: Arg[String] = Arg.Undefined,
  parents: Arg[Seq[String]] = Arg.Undefined,
  name: Arg[String] = Arg.Undefined,
  stackgroup: Arg[String] = Arg.Undefined,
  connectgaps: Arg[Boolean] = Arg.Undefined,
  visible: Arg[BooleanOr[Trace.Visibility]] = Arg.Undefined,
  delta: Arg[Delta] = Arg.Undefined,
  gauge: Arg[Gauge] = Arg.Undefined,
  number: Arg[PlotNumber] = Arg.Undefined,
  transforms: Arg[Seq[Transform]] = Arg.Undefined,
  orientation: Arg[Trace.Orientation] = Arg.Undefined,
  width: Arg[OneOrArrayOf[Number]] = Arg.Undefined,
  boxmean: Arg[Trace.BoxMean] = Arg.Undefined,
  opacity: Arg[Number] = Arg.Undefined,
  showscale: Arg[Boolean] = Arg.Undefined,
  colorscale: Arg[ColorScale] = Arg.Undefined,
  zsmooth: Arg[FalseOr[Trace.ZSmooth]] = Arg.Undefined,
  ygap: Arg[Number] = Arg.Undefined,
  xgap: Arg[Number] = Arg.Undefined,
  transpose: Arg[Boolean] = Arg.Undefined,
  autobinx: Arg[Boolean] = Arg.Undefined,
  xbins: Arg[Trace.XBins] = Arg.Undefined,
  value: Arg[Number] = Arg.Undefined,
  values: Arg[Seq[Datum]] = Arg.Undefined,
  labels: Arg[Seq[Datum]] = Arg.Undefined,
  direction: Arg[Trace.Direction] = Arg.Undefined,
  hole: Arg[Number] = Arg.Undefined,
  rotation: Arg[Number] = Arg.Undefined,
  theta: Arg[Seq[Datum]] = Arg.Undefined,
  r: Arg[Seq[Datum]] = Arg.Undefined,
  customdata: Arg[Seq[Datum]] = Arg.Undefined,
  domain: Arg[Trace.Domain] = Arg.Undefined,
  title: Arg[DataTitle] = Arg.Undefined,
  branchvalues: Arg[Trace.BranchValues] = Arg.Undefined,
)
