...
final case class Trace(
  ...
  values: OptArg[Seq[Datum]] = OptArg.Undefined,
  labels: OptArg[Seq[Datum]] = OptArg.Undefined,
  ...
  theta: OptArg[Seq[Datum]] = OptArg.Undefined,
  r: OptArg[Seq[Datum]] = OptArg.Undefined,
  customdata: OptArg[Seq[Datum]] = OptArg.Undefined,
