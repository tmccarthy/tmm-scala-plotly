...
final case class ProjectSettingsHelper private (
  ...
  primaryScalaVersion: String      = "2.13.3", // Change these in the circleci file if you change them here
  ...
  def settingsForSubprojectCalled(name: String) =
    Seq(
